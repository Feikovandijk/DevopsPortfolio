...
export const nl: Translation = {
    ...
    experience: {
        ...
        items: [
            ...
            },
            {
                ...
                date: "Sept 2023 - Okt 2024",
                description: "Locatiemanager verantwoordelijk voor 20+ medewerkers. Beheerde HR, financiën en dagelijkse operaties met een focus op veiligheid en besluitvorming onder druk.",
                tags: ["Leiderschap", "Management", "Operaties"]
            }
        ]
    },
    contact: {
    ...
    aboutPage: {
        ...
        bio: {
            ...
            p4: "Ik hecht veel waarde aan samenwerking en geloof dat geweldige games worden gebouwd door teams die ideeën delen en elkaar steunen. Als ik niet verdiept ben in game development, vind je me waarschijnlijk buiten, rotsen beklimmend en nieuwe avonturen omarmend."
        },
